 ...
 *
 * Disassembly of DSDT.aml, Sat May 12 16:24:26 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001F8B0 (129200)
 *     Revision         0x02
 *     Checksum         0x4C
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "SKL     "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x9FF57000, 0x072C)
    ...
    OperationRegion (MNVS, SystemMemory, 0x9FF68018, 0x1000)
    ...
    Scope (\_SB.PCI0.LPCB.EC)
    {
        ...
        {
            Fatal (0x01, 0x80010000, 0x00010FD0)
        }
